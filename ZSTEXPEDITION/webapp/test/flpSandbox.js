		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comtelefonicafioristzexpedicion-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtelefonicafioristzexpedicion-display": {
								"semanticObject": "comtelefonicafioristzexpedicion",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.telefonica.fiori.st.zexpedicion",
									"url": sap.ui.require.toUrl("com/telefonica/fiori/st/zexpedicion")
								}
							}
						}
					}
